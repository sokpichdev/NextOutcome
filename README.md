...
> Captured from the current dev build in the simulator — not a final/curated set. Tiles marked
> **PLACEHOLDER** are slots waiting on a capture; the README already points at the final path.
