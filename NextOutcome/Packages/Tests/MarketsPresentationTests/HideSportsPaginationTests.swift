...
final class HideSportsPaginationTests: XCTestCase {
    func test_loadMore_advancesPastAllSportsPage_whenHideSportsEnabled() async throws {
        ...
        let vm = EventListViewModel(fetchEvents: fetchEvents, fetchRelatedTags: FetchRelatedTagsUseCase.stub, searchEvents: SearchEventsUseCase.stub, fetchFeaturedEvents: FetchFeaturedEventsUseCase.stub)
